...
/*	auto origin = Director::getInstance()->getVisibleOrigin();
	...
	bool ret = JniHelper::getStaticMethodInfo(info, "org/cocos2dx/cpp/AppActivity", "getTestJni", "()J");
	if (ret)
	{
		Log.e("myErr","call void func1() succeed");
		//传入类ID和方法ID，小心方法名写错，第一个字母是大写
		info.env->CallStaticLongMethod(info.classID, info.methodID);
